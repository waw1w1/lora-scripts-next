...
**改进欢迎：** 若有更稳、更简单的打包链路、脚本入口或验收门禁，**直接 PR 改本文 / `build-scripts/` 覆盖现稿即可**——不要求迁就当前写法。协作讨论见 [Discussion #257](https://github.com/wochenlong/lora-scripts-next/discussions/257)。
