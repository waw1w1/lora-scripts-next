  ...
  <label class="schema-field" :class="{ 'has-error': error, 'schema-field--compact': compact }">
    ...
    <span class="field-control-wrap">
      <span class="field-control">
        ...
        <PreviewSampleField v-else-if="field.role === 'preview-samples'" :samples="modelValue as string[] | undefined" :disabled="field.disabled" @update:samples="emit('update:modelValue', $event)" />
